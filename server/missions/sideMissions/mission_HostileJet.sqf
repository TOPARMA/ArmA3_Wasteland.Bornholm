...
_setupObjects =
{
	...
	_missionHintText = format ["Warning! A <t color='%2'>%1</t> has been spotted flying over the island. Intercept it and recover its cargo!", _vehicleName, sideMissionColor];
